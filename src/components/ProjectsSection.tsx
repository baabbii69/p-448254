...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Modern digital banking interface with focus on security, trust, and seamless financial transactions.",
  ...
  },
  {
    ...
    description:
      "Mobile app for students to access educational resources and services.",
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="text-center mb-16 animate-on-scroll">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            A showcase of my recent work across various industries and
            platforms, demonstrating user-centered design solutions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-on-scroll">
          {projects.map((project, index) => (
            <Card
              key={index}
              className="group overflow-hidden shadow-elegant transition-transform duration-300 ease-out hover:shadow-lg hover:-translate-y-1"
            >
                ...
                <div className="flex flex-wrap gap-2">
                  {project.hasCaseStudy && (
                    <Button
                      ...
                      onClick={() => handleViewCaseStudy(project.slug)}
                    >
